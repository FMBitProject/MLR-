...
const dictionaries = {
  id: {
    ...
    login: {
      ...
      password: "Kata sandi",
      submit: "Masuk",
      demoHint: "Akun demo (kata sandi: DemoMLR2026!)",
    ...
    library: {
      ...
      distributionEmpty: "Belum ada kanal yang ditandai live untuk materi ini.",
      distributionLive: "Live sejak",
      distributionPulled: "Ditarik",
      distributionAdd: "Tandai Live di Kanal",
      distributionChannel: "Kanal",
      distributionLabel: "Detail (opsional)",
      distributionLabelPlaceholder: "cth. Instagram @brand, banner homepage…",
      distributionPublish: "Tandai Live",
      distributionPull: "Tarik dari Kanal Ini",
    },
    newSubmission: {
    ...
    audit: {
      ...
      actions: {
        ...
        logged_in: "Masuk",
        distribution_published: "Menandai live di kanal",
        distribution_pulled: "Menarik dari kanal",
      },
    },
    settings: {
      title: "Pengaturan",
      ...
      billingUpgrade: "Upgrade & Bayar",
      billingPaying: "Menyiapkan pembayaran…",
      billingPayPending: "Lanjutkan Pembayaran",
      billingFree: "Gratis",
      billingFreeNote: "Paket Starter gratis selamanya — upgrade kapan saja, tanpa kartu kredit.",
      billingCurrentPlan: "(saat ini)",
      billingError: "Gagal menyiapkan pembayaran. Coba lagi sebentar; bila tetap gagal, hubungi kami.",
    ...
    pricing: {
      ...
      startFreeCta: "Mulai Gratis",
      free: "Gratis",
      contactSales: "Diskusikan kebutuhan khusus",
      usersUnit: "pengguna",
      productsUnit: "produk",
  ...
  en: {
    ...
    login: {
      ...
      password: "Password",
      submit: "Sign in",
      demoHint: "Demo account (password: DemoMLR2026!)",
    ...
    library: {
      ...
      distributionEmpty: "No channel has been marked live for this material yet.",
      distributionLive: "Live since",
      distributionPulled: "Pulled",
      distributionAdd: "Mark Live on Channel",
      distributionChannel: "Channel",
      distributionLabel: "Detail (optional)",
      distributionLabelPlaceholder: "e.g. Instagram @brand, homepage banner…",
      distributionPublish: "Mark Live",
      distributionPull: "Pull from This Channel",
    },
    newSubmission: {
    ...
    audit: {
      ...
      actions: {
        ...
        logged_in: "Signed in",
        distribution_published: "Marked live on channel",
        distribution_pulled: "Pulled from channel",
      },
    },
    settings: {
      title: "Settings",
      ...
      billingUpgrade: "Upgrade & Pay",
      billingPaying: "Preparing payment…",
      billingPayPending: "Continue Payment",
      billingFree: "Free",
      billingFreeNote: "The Starter plan is free forever — upgrade any time, no credit card.",
      billingCurrentPlan: "(current)",
      billingError: "Couldn't start the payment. Try again shortly; if it keeps failing, contact us.",
    ...
    pricing: {
      ...
      free: "Free",
      contactSales: "Discuss custom requirements",
      usersUnit: "users",
